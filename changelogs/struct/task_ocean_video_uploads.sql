...
Date: 2020-11-18 17:58:19
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for task_ocean_video_uploads
-- ----------------------------
DROP TABLE IF EXISTS `task_ocean_video_uploads`;
CREATE TABLE `task_ocean_video_uploads` (
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='巨量视频上传任务表';
