...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        if(Functions::isProduction()){
            ...
            $schedule->command('ocean:sync_account_report --date=today --run_by_new_account=1 --key_suffix=run_by_new_account')->cron('*/3 * * * *');
            ...
            // 巨量创意报表同步
            $schedule->command('ocean:sync_creative_report --date=today --run_by_account_cost=1 --multi_chunk_size=3')->cron('*/2 * * * *');
